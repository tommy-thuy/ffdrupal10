...
/**
 * Provides a 'array_textfield' ConditionType.
 *
 * @SmartConditionType(
 *  id = "array_textfield",
 *  label = @Translation("Array(textfield)"),
 * )
 */
class ArrayTextfield extends ConditionTypeBase {

  /**
   * {@inheritdoc}
   */
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    $form['#attributes']['class'][] = 'condition-array-textfield';
    $form['op'] = [
      '#type' => 'select',
      ...
      $element['value']['#states'] = [
        ...
        'required' => [
          'select[name="' . $parent_string . '"]' => [
            ['value' => 'contains_equals'],
            ['value' => 'contains_contains'],
            ['value' => 'contains_starts_with'],
          ],
        ],
      ];
    }
  ...
  public function getOperators() {
    return [
      'contains_equals' => $this->t('Contains(equals)'),
      'contains_contains' => $this->t('Contains(contains)'),
      'contains_starts_with' => $this->t('Contains(starts with)'),
