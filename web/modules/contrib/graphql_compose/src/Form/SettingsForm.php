  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['advanced']['expose_entity_ids'] = [
      ...
      '#description' => $this->t('
        ...
        Leaving this disabled can help protect your schema against enumeration attacks.
    ...
    $form['advanced']['simple_unions'] = [
      ...
      '#description' => $this->t('
        Enable to reduce the amount of unions in your schema.
        This can help simplify your schema depending on your use case.
