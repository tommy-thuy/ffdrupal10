...
class EntityTypePluginQueryHelper implements ConnectionQueryHelperInterface {
   ...
   *   The GraphQL entity buffer.
   */
  protected function graphqlEntityBuffer(): EntityBuffer {
    return $this->graphqlEntityBuffer ??= \Drupal::service('graphql.buffer.entity');
  }
  ...
  public function getLimit(): ?int {
    return $this->configFactory()->get('graphql_compose.settings')->get('settings.edge_max_limit');
  }
