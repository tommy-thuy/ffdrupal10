...
class View extends GraphQLComposeSchemaTypeBase {
  ...
  public function getTypes(): array {
    ...
    foreach (Views::getApplicableViews('graphql_display') as $applicable_view) {
      ...
      // Type to return for results.
      $base_type_plugin = $this->gqlEntityTypeManager->getPluginInstance($base_type->id());
      if ($row_plugin instanceof GraphQLEntityRow && $base_type_plugin) {
      ...
      $types[] = new ObjectType([
        ...
        'fields' => fn() => [
          ...
          'results' => [
            'type' => Type::nonNull(Type::listOf(Type::nonNull(static::type($row_type)))),
  ...
  private function getFieldTypes(GraphQL $display): array {
    ...
    foreach (array_keys($fields) as $field_id) {
      ...
      // Alias set by user.
      $field_alias = $option['alias'] ?? NULL ?: $default_alias;
      $field_type = $option['type'] ?? NULL ?: 'String';
